 ...
 * Zookeeper高级功能
 *    paxos 选举算法
 *    zookeeper 创建临时，临时有序， 永久，永久有序节点
 *              zookeeper与kafka topic的关系
 *              zookeeper的长连接机制
 *              zookeeper的 Observer, Watch 机制
 */
@Service
public class ZookeeperLock implements Lock, Watcher{
    //@Value("${zookeeper.servers}")
    private String zookeeperServers = "10.25.193.114:20881";
    ...
    private CountDownLatch connectedSignal=new CountDownLatch(0);
...
//    }
    ...
    /**
     * 没有使能Spring的自动配置功能，所有不能使用Spring的注解@Value
     * */
//    public static void main(String[] args){
//        ZookeeperLock zookeeperLock = new ZookeeperLock("Distribution Lock");
